...
root = Tk()
label_distance = Label(master=root, text='Trip Distance: ', font='bold', bd=5, relief='raised')
...
label_fuel_consumption = Label(master=root, text='Fuel consumption: ', font='bold', bd=5, relief='raised')
...
label_liters_per_km = Label(master=root, text='l/km', font='bold', bd=5, relief='raised')
label_liters_per_km.grid(row=1, column=2, padx=10, sticky='W')
label_price = Label(master=root, text='Fuel Price: ', font='bold', bd=5, relief='raised')
...
button = Button(master=root, text='Calculate!', command=calculator, font='bold', bd=10, relief='raised')
